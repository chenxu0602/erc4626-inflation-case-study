...
/// @notice Minimal ERC4626-style vault with virtual assets / virtual shares mitigation.
/// @dev This is not a full ERC4626 implementation. It is a focused case-study contract.
contract SafeVirtualOffsetVault {
    ...
    /// @notice Large virtual share base makes the first depositor unable to dominate ownership cheaply.
    uint256 public constant VIRTUAL_SHARES = 1e18;

    /// @notice Small virtual asset base prevents division-by-zero and anchors the initial exchange rate.
    ...
    constructor(MockERC20 asset_) {
        ...
        name = "Safe Virtual Offset ERC4626 Vault Share";
        symbol = "svSHARE";
    ...
    /// @notice Reads live token balance, but conversion math includes virtual offsets.
